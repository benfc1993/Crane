...
namespace Crane {
	...
	std::function<void(Entity selectedEntity, glm::vec2 viewportBoundsMin, glm::vec2 viewportBoundsMax)> ImGuizmoLayer::OnUpdate()
	{
		// HandleInput();
		return [&](Entity selectedEntity, glm::vec2 viewportBoundsMin, glm::vec2 viewportBoundsMax) {
			m_GizmoType = 7;
