...
#define CR_PROFILE_FUNCTION() CR_PROFILE_SCOPE(__PRETTY_FUNCTION__)
#else
#define CR_BEGIN_PROFILE_SESSION(name, filepath)
#define CR_END_PROFILE_SESSION()
#define CR_PROFILE_FUNCTION(name)
#define CR_PROFILE_SCOPE()
#endif