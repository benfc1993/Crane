...
namespace Crane {
	...
	void ScriptEngine::InitMono()
	{
		...
		s_Data->AppDomain = mono_domain_create_appdomain("CraneScriptRuntime", nullptr);
		mono_domain_set(s_Data->AppDomain, true);

		// Move this maybe
		s_Data->CoreAssembly = LoadCSharpAssembly("Resources/Scripts/Crane-ScriptCore.dll");
		...
		MonoObject* res = mono_runtime_invoke(printIntFunc, instance, &param, nullptr);

		std::string str = mono_string_to_utf8(mono_object_to_string(res, nullptr));
		CR_CORE_INFO("Value: {0}", str);
