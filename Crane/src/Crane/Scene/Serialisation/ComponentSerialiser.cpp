...
namespace Crane {
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<TagComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<HierarchyComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<PrefabComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<TransformComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<CameraComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<SpriteRendererComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<CircleRendererComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<RigidBody2DComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<BoxCollider2DComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<CircleColliderComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<ParticleSystemComponent>(YAML::Emitter& out, Entity entity)
	{
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<ScriptComponent>(YAML::Emitter& out, Entity entity)
	{
...
#undef FIELD_TYPE
	...
	template <>
	void ComponentSerialiser::SerialiseComponent<NativeScriptComponent>(YAML::Emitter& out, Entity entity)
	{
		return;
	}
};