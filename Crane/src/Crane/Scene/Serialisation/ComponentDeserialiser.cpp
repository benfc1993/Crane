...
namespace Crane {
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<TransformComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<HierarchyComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<PrefabComponent>(YAML::Node& data, Entity& entity)
	{
		YAML::Node node = data["PrefabComponent"];
		if (!node) return;
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<CameraComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<SpriteRendererComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<CircleRendererComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<RigidBody2DComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<BoxCollider2DComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<CircleColliderComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<ParticleSystemComponent>(YAML::Node& data, Entity& entity)
	{
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<ScriptComponent>(YAML::Node& data, Entity& entity)
	{
...
#define FIELD_TYPE(FieldType, Type) case ScriptFieldType::FieldType: \
	...
	template <>
	void ComponentDeserialiser::DeserialiseComponent<NativeScriptComponent>(YAML::Node& data, Entity& entity)
	{
		return;
	}
}